...
static const char DeviceId[] = "InfyTempCheck";
static const char connectionString[] = "HostName=InfyIoTHub.azure-devices.net;DeviceId=InfyTempCheck;SharedAccessKey=f1mLnJDGNL08+Wvn183ETJpu4o27ZyQkmvaEY+wEzDI=";
...
EXECUTE_COMMAND_RESULT TurnFanOff(ContosoAnemometer* device)
{
    ...
    digitalWrite(LED_BUILTIN, redLedState);
            ...
            else
            {
                ...
                else
                {
                    ...
                    while (1)
                    {
                        ...
                        if (Curr_time_ms >= Prev_time_ms + 60000)
                        {
